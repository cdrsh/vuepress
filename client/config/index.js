...
const config={
  ...
  //client
  clienthttp: process.env.HTTP_CLIENT||'http',
  clienthost: process.env.HOST_CLIENT||'localhost',
  clientport: process.env.PORT_CLIENT||'8080',
};

const updCfg = require('./updateConfigs');
updCfg.updateConfigClient(config);
...
module.exports = {
  build: {
    ...
    assetsSubDirectory: '../../backend/public/client',
    assetsPublicPath: '/',
